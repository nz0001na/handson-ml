...
Once you've built `nn_model()` and learned the right parameters, 
...
'''
You will initialize the weights (W) matrices with random values.
    Use: np.random.randn(a,b) * 0.01 to randomly initialize a matrix of shape (a,b).
You will initialize the bias (b) vectors as zeros.
