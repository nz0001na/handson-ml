...
Don't worry, this assignment will show you exactly how to carry out each of these steps!
...
''' (2) Build a L-layer NN
Instructions:
    The model's structure is *[LINEAR -> RELU] × (L-1) -> LINEAR -> SIGMOID*. I.e., 
    it has 𝐿−1 layers using a ReLU activation function followed by an output layer with a sigmoid activation function.
...
'''  **************
Detailed Architecture of Figure 2: 2-layer NN
...
'''  ************** 
Detailed Architecture of Figure 3: L-layer NN

    The input is a (64,64,3) image which is flattened to a vector of size (12288,1).
    The corresponding vector: [𝑥0,𝑥1,...,𝑥12287]𝑇 is then multiplied by the weight matrix 𝑊[1] and then you add the intercept 𝑏[1]
